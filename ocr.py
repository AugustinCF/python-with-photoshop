    ...
    try:
        ...
        if textLayer.Kind == 2:  # 2 corresponds to the text layer
            ...
            if layer_name == 'oras':
                ...
                textItem.Contents = text  # Set the text content without modifications for other layers
...
this is the project
i want to  display column in interface to set posision of the layer x,y and font size